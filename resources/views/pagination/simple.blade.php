            ...
            <ul class="pagination m-0">
                ...
                @if ($paginator->onFirstPage())
                    <li class="page-item disabled" aria-disabled="true">
                        <span class="page-link">@lang('datatables::datatable.pagination.previous')</span>
                    </li>
                @else
                    @if (method_exists($paginator, 'getCursorName'))
                        <li class="page-item">
                            <button dusk="previousPage" type="button" class="page-link"
                                ...
                                wire:loading.attr="disabled" rel="prev">@lang('datatables::datatable.pagination.previous')</button>
                        </li>
                    @else
                        <li class="page-item">
                            <button type="button"
                    ...
                    @if (method_exists($paginator, 'getCursorName'))
                        <li class="page-item">
                            <button dusk="nextPage" type="button" class="page-link"
                                ...
                                wire:loading.attr="disabled" rel="next">@lang('datatables::datatable.pagination.next')</button>
                        </li>
                    @else
                        <li class="page-item">
                            <button type="button"
                ...
                @else
                    <li class="page-item disabled" aria-disabled="true">
                        <span class="page-link">@lang('datatables::datatable.pagination.next')</span>
                    </li>
                @endif
            </ul>
        </nav>
